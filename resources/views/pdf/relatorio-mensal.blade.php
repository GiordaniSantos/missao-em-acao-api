    ...
    <body>
        ...
        <header class="header">
            <div class="header-title-container">
                <h1>Relatório de Atividades Pastorais</h1>
            </div>
            <div class="meta-info">
        ...
        <main>
            ...
            <section class="group-section ministration">
                <h2>2. Frequência</h2>
                <p class="section-description">Registro das frequências dos membros, comungantes e não comungantes.</p>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        @foreach ($results['membresias'] as $membresia)
                            <tr>    
                        ...
                        @endforeach
                        <tr>
                            <td>Membros Comungantes Totais</td>
                            <td>{{ $results['comungante'] }}</td>
                        </tr>
                        <tr>
                            <td>Membros Não Comungantes Totais</td>
                            <td>{{ $results['naoComungante'] }}</td>
                        </tr>
                    </tbody>
                </table>
            </section>
